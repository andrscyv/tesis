...
\include{Chapters/0.introduccion.tex}

\include{Chapters/1.analisis.tex}

\include{Chapters/2.el_juego_de_domino.tex}

\include{Chapters/3.diseno.tex}

\include{Chapters/4.implementacion.tex}

\include{Chapters/5.resultados.tex}
...
\begin{thebibliography}{111}
      ...
      % La manera recomendada para citar papers o libros en el formato de
      % Chicago esta en el siguiente vínculo:
      % https://www.chicagomanualofstyle.org/tools_citationguide/citation-guide-2.html

      % Es importante poner el apellido del autor seguido del año de
      % publicación, una coma y las páginas consultadas en el texto antes de
      % puntuar y entre paréntesis para las citas en el cuerpo de la tesis

      % Ejemplo:

      % Las \textit{causas próximas} del crecimiento son conocidas: tecnología,
      % capital humano y físico. La pregunta es ¿por qué unos países sí tienen
      % estas causas próximas y otros no? La respuesta son las \textit{causas
      % fundamentales:} suerte, geografía, cultura e instituciones (Acemoglu
      % 2009, 110).

      %AAAAA \bibitem{abram57} Abramovitz, Moses. 1957. «Resources on Output
      % Trends in the United States since 1870.» \textit{The American Economic
      % Review} 46 (2): 5–23.
      \bibitem{agneris16} Angeris, G., \& Li, L. (2016). CS 221 Project Final :
      DominAI. Recuperado de
      https://web.stanford.edu/~guillean/papers/dominai.pdf

      \bibitem{bowling17}Bowling, M., Burch, N., Johanson, M. \& Tammelin, O.
      (2017). Heads-up limit hold’em poker is solved. Communications of the ACM,
      60(11), 81-88. https://doi.org/10.1145/3131284

      \bibitem{browne12}Browne, C. B., Powley, E., Whitehouse, D., Lucas, S. M.,
      ...
      % \bibitem{fielding22}Fielding, R., Nottingham, M., \& Reschke, J. (2022,
      \bibitem{ietf22}IETF. (2022, June 1). HTTP Semantics. RFC Editor.
      Recuperado el October 19, 2022, de https://www.rfc-editor.org/info/rfc9110

      \bibitem{martin08}Martin, R. C. (2008). "Clean Code: A Handbook of Agile
      Software Craftsmanship." Prentice Hall.

      \bibitem{mnih13}Mnih, V., Kavukcuoglu, K., Silver, D., Graves, A.,
      Antonoglou, I., Wierstra, D. \& Riedmiller, M. (2013). Playing Atari with
      Deep Reinforcement Learning. , .

      \bibitem{richard10}Long, Jeffrey Richard et al. “Understanding the Success
      of Perfect Information Monte Carlo Sampling in Game Tree Search.” AAAI
      (2010).

      \bibitem{schach07}Schach, S. R. (2007). "Object-oriented and classical
      software engineering" (7th ed.). New York: McGraw-Hill.


      \bibitem{whitehouse14}Whitehouse, D. (2014). Monte Carlo Tree Search for games with
