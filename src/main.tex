...
\bibitem{agneris16} Angeris, G., \& Li, L. (2016). CS 221 Project Final : DominAI. Recuperado de https://web.stanford.edu/~guillean/papers/dominai.pdf	
\bibitem{basin98}Frank, I., and Basin, D. 1998. Search in games with in- complete information: A case study using bridge card play. Artificial Intelligence 87–123. 
\bibitem{ginsberg01}Ginsberg, M. L. (2001). GIB: Imperfect Information in a Computationally Challenging Game. Journal of Artificial Intelligence Research, 14, 303-358. https://doi.org/10.1613/jair.820

\bibitem{richard10}Long, Jeffrey Richard et al. “Understanding the Success of Perfect Information Monte Carlo Sampling in Game Tree Search.” AAAI (2010).

\bibitem{mnih13}Mnih, V., Kavukcuoglu, K., Silver, D., Graves, A., Antonoglou, I., Wierstra, D. \& Riedmiller, M. (2013). Playing Atari with Deep Reinforcement Learning. , .
