...
algoritmo de Counterfactual Regret Minimization ha sido utilizado para crear
jugadores de póker. Dicho algoritmo utiliza un enfoque iterativo en el que se
busca aproximar una función que para cada estado del juego defina una acción
óptima.
...
una unica jugada posible. Dejamos como linea de investigación para futuras
